...
Na segunda linha, a variável \textbf{dados2mi} recebe um \textit{array numpy} obtido dos dados de uma simulação de 2 milhões de jogadas. Uma saída típica para \textbf{dados2mi} é:
...
Após a realização das simulações, os dados são resumidos em um \textit{DataFrame Pandas}, como mostra a Figura \ref{data_frame}.
