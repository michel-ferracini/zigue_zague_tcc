...
Nesta seção, é realizado um detalhamento do ferramental utilizado neste estudo, como apresentado na Seção \ref{metodologia}. Assim, mostra-se a viabilidade teórica do trabalho de avaliação e melhoria de desempenho computacional propostos, indicando as bases tomadas como parâmetro para o mesmo.
...
O caminho adotado para realizar a avaliação do código do Projeto Zigue-Zague é o seguinte:

\begin{enumerate}
	\item Geração de um diagrama relacionando todos os métodos desenvolvidos para realizar o mapeamento do tabuleiro (antes da seção \aspas{Análise do Tabuleiro}).
	\item Geração de um diagrama relacionando todos os métodos desenvolvidos na seção \aspas{Análise do Tabuleiro}.
\end{enumerate}
